  ...
  _checkRequirements() {
    return (
      typeof this.requires != "object" ||
        Object.entries(this.requires).forEach(([t, r]) => {
          if (
            !(function (e, i, u) {
              const g = (function (a, h) {
                var c;
                if (a === "swup") return (c = h.version) != null ? c : "";
                {
                  var l;
                ...
                ((a, h) =>
                  h.every((c) => {
                    ...
                    return ((w, b) => {
                      ...
                      (m = d((m = a))),
                      (f = d(f)),
                      m.localeCompare(f, void 0, { numeric: !0 })),
                      l || ">="
                    );
                  }))(g, i)
              );
            })(t, (r = Array.isArray(r) ? r : [r]), this.swup)
          ) {
            const e = `${t} ${r.join(", ")}`;
            throw new Error(
  ...
  on(t, r, e = {}) {
    ...
    r =
      !(i = r).name.startsWith("bound ") || i.hasOwnProperty("prototype")
        ? r.bind(this)
        : r;
    const u = this.swup.hooks.on(t, r, e);
    return this.handlersToUnregister.push(u), u;
  }
  once(t, r, e = {}) {
    return this.on(t, r, o({}, e, { once: !0 }));
  }
  before(t, r, e = {}) {
    return this.on(t, r, o({}, e, { before: !0 }));
  }
  replace(t, r, e = {}) {
    return this.on(t, r, o({}, e, { replace: !0 }));
  }
  off(t, r) {
    return this.swup.hooks.off(t, r);
  }
}
export { y as e };
