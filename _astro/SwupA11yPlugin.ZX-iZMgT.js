import { e as g } from "./index.modern.BC8Oj8jT.js";
import { l as y } from "./Swup.Cr7ogLqN.js";
(function () {
  if (
    ...
    if (HTMLElement.prototype.nativeFocus === void 0 && !s) {
      ...
      var n = function (i) {
          for (
            ...
            (e.offsetHeight < e.scrollHeight ||
              ...
              u.push([e, e.scrollTop, e.scrollLeft]),
              (e = e.parentNode);
          return (e = a), u.push([e, e.scrollTop, e.scrollLeft]), u;
        },
        o = function (i) {
          for (var e = 0; e < i.length; e++)
            (i[e][0].scrollTop = i[e][1]), (i[e][0].scrollLeft = i[e][2]);
          i = [];
        },
        r = function (i) {
          if (i && i.preventScroll) {
            ...
            } else this.nativeFocus(), o(e);
          } else this.nativeFocus();
        };
      HTMLElement.prototype.focus = r;
    }
  }
})();
function h() {
...
class w {
  constructor() {
    ...
    (this.id = "swup-announcer"),
      (this.style =
        "position:absolute;top:0;left:0;clip:rect(0 0 0 0);clip-path:inset(50%);overflow:hidden;white-space:nowrap;word-wrap:normal;width:1px;height:1px;"),
      (this.region = void 0),
      (this.region = (t = this.getRegion()) != null ? t : this.createRegion());
  }
  getRegion() {
  ...
  createRegion() {
    const t = (function (n) {
      ...
      return (o.innerHTML = n), o.content.children[0];
    })(
...
function m(s) {
  let t;
  if (
    ((t = typeof s == "string" ? document.querySelector(s) : s),
...
class S extends g {
  constructor(t = {}) {
    super(),
      ...
      (this.handleAnchorScroll = (n, { hash: o }) => {
        const r = this.swup.getAnchorElement(o);
        r instanceof HTMLElement && m(r);
      }),
      (this.options = h({}, this.defaults, t)),
      (this.announcer = new w());
  }
  mount() {
  ...
  announceContent(t) {
    this.swup.hooks.callSync("content:announce", t, void 0, (n) => {
      n.a11y.announce === void 0 &&
        (n.a11y.announce = this.getPageAnnouncement()),
        n.a11y.announce &&
          this.announcer.announce(n.a11y.announce, this.announcementDelay);
    });
  }
  focusContent(t) {
    this.swup.hooks.callSync("content:focus", t, void 0, (n) => {
      n.a11y.focus &&
        ((this.options.autofocus &&
          (function () {
            const o = (function () {
              const r = document.querySelector("body [autofocus]");
              if (
                r &&
                !r.closest('[inert], [aria-disabled], [aria-hidden="true"]')
              )
                return r;
            })();
            return !!o && (o !== document.activeElement && o.focus(), !0);
          })() === !0) ||
          m(n.a11y.focus));
    });
  }
  getPageAnnouncement() {
    const { headingSelector: t, announcements: n } = this.options;
    return (function ({ headingSelector: o = "h1", announcements: r = {} }) {
      var i, e;
      const u = document.documentElement.lang || "*",
        { href: a, url: d, pathname: f } = y.fromUrl(window.location.href),
        l = (i = (e = r[u]) != null ? e : r["*"]) != null ? i : r;
      if (typeof l != "object") return;
      const c = document.querySelector(o);
      c ||
        console.warn(
          `SwupA11yPlugin: No main heading (${o}) found on new page`
        );
      const v =
        c?.getAttribute("aria-label") ||
        c?.textContent ||
        document.title ||
        p(l.url, { href: a, url: d, path: f });
      return p(l.visit, { title: v, href: a, url: d, path: f });
    })({ headingSelector: t, announcements: n });
  }
  disableAnimations(t) {
    this.options.respectReducedMotion &&
      window.matchMedia("(prefers-reduced-motion: reduce)").matches &&
      ((t.animation.animate = !1), (t.scroll.animate = !1));
  }
}
export { S as default };
